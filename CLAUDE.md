...
- Estructura: `api/src/{config, common/{decorators,filters,utils}, infra/{prisma,redis,mail,storage,messaging,crypto,observability}, health, modules/{auth,users,categories,events,venues,media,pricing,inventory,orders}}`.
