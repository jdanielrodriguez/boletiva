...
- Estructura: `api/src/{config, common/{decorators,filters,utils}, infra/{prisma,redis,mail,storage,messaging,crypto,observability}, health, modules/{auth,users,categories,events,venues,media,pricing,inventory,orders,ledger,payments}}`.
- **Ola 3 (Órdenes + pagos) EN CURSO.** 119 tests verdes.
