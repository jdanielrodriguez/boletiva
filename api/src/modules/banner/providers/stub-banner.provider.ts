...
import { BannerImage, BannerPrompt, BannerProvider } from '../banner.provider';
...
export class StubBannerProvider implements BannerProvider {
  ...
  <text x="600" y="560" fill="#ffffff" opacity="0.9" font-family="Arial, sans-serif" font-size="26" font-weight="600" text-anchor="middle">pasa eventos</text>
</svg>`;
