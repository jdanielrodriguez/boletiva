...
import { ResendCodeComponent } from '../../shared/ui/resend-code.component';
 ...
 * campo de código y completamos con /auth/2fa/verify. El reenvío (botón + contador)
 * usa el control compartido `app-resend-code` (F2), igual que los demás flujos.
 */
@Component({
  selector: 'app-login',
  imports: [FormsModule, RouterLink, TranslatePipe, OtpInputComponent, ResendCodeComponent, IconComponent],
