...
export const promoter = {
  ...
  panel: {
    ...
    tierFree: 'Free plan',
    tierPremium: 'Premium',
    trialUntil: 'Premium trial until {{date}}',
    upgradeCta: 'Upgrade to Premium',
    feature: 'Feature on home',
    featureHint: 'Feature your event in the home slider (premium benefit; upcoming published events only).',
    featured: 'Event featured on home.',
    unfeatured: 'Event removed from home.',
    featureError: 'Could not change the featured state.',
    featurePremiumOnly: 'Featuring events is a premium benefit.',
  ...
  validators: {
    ...
    subtitle: 'Invite by email whoever will scan tickets at the gate. They get a link and a code to open the validator.',
    emailPlaceholder: 'email@example.com',
    invite: 'Invite',
    inviting: 'Inviting…',
    invited: 'Invitation sent to {{email}}.',
    inviteError: 'Could not invite the validator.',
    issuedTitle: 'Access for {{email}}',
    issuedHint: 'Share this link with the validator (shown only once). It opens the validator directly.',
    link: 'Link',
    copy: 'Copy link',
    copied: 'Link copied.',
    empty: 'No validators yet. Invite the first one by email.',
    loadError: 'Could not load the validators.',
    active: 'Active',
    disabledStatus: 'Disabled',
    disable: 'Disable',
    reenable: 'Re-enable',
    resend: 'Resend link',
    resendHint: 'Generates a new link (invalidates the previous one) and resends it by email.',
    resent: 'Link resent to {{email}} (the previous one was invalidated).',
    disableTitle: 'Disable validator',
    disableBody: 'Remove access for {{email}}? Their link will stop working instantly.',
    disableConfirm: 'Disable',
    disabled: 'Validator disabled.',
    reenabled: 'Validator re-enabled. A new access was generated for {{email}}.',
    remove: 'Remove',
    removeTitle: 'Remove validator',
    removeBody: 'Remove {{email}} from the list? This cannot be undone (you can invite them again).',
    removeConfirm: 'Remove',
    removed: 'Validator removed.',
    disableAll: 'Disable all',
    disableAllTitle: 'Disable all validators',
    disableAllBody: 'This removes access for ALL validators of the event. You can re-enable them later.',
    disableAllConfirm: 'Disable all',
