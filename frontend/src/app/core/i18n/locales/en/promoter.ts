...
export const promoter = {
  ...
  validators: {
    ...
    issuedHint: 'Share this link and code with the validator (shown only once).',
    link: 'Link',
    code: 'Code',
    copy: 'Copy',
    copied: 'Copied.',
    ...
    disableBody: 'Remove access for {{email}}? Their link and code will stop working instantly.',
