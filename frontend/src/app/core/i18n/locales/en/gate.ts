...
export const gate = {
  ...
  manifestUnsupported:
    'This device cannot verify the signature securely. Use an up-to-date browser (with Ed25519) to validate.',
  accessRevoked: 'Your validator access was revoked. Validation stopped; contact the organizer.',
  // Camera (required)
