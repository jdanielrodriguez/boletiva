...
export const promoter = {
  ...
  validators: {
    ...
    issuedHint: 'Comparte este enlace y código con el validador (se muestran una sola vez).',
    link: 'Enlace',
    code: 'Código',
    copy: 'Copiar',
    copied: 'Copiado.',
    ...
    disableBody: '¿Quitar el acceso de {{email}}? Su enlace y código dejarán de funcionar al instante.',
